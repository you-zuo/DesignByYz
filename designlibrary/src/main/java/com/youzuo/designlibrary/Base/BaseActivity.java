package com.youzuo.designlibrary.Base;
...
import com.youzuo.designlibrary.R;
import java.util.ArrayList;
import java.util.List;
import listener.OnRequestPermissionListener;
...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    //网络状态加载不同布局
    private LinearLayout network_status_layout;
    //左边返回键
